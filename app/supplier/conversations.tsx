...
export default function SupplierConversationsScreen() {
  ...
  useEffect(() => {
    // If we have no authenticated user, ensure UI is not stuck in loading state.
    if (!currentUser) {
        ...
        >
          ...
          <View style={styles.conversationInfo}>
            <View style={styles.nameRow}>
              <Text
                style={[styles.consumerName, hasUnread && styles.unreadText]}
                numberOfLines={1}
              >
                {item.consumerName}
              </Text>
            ...
            >
              {lastMessage
                ? lastMessage.text
                : "Start processing this customer order"}
            </Text>
          </View>
          {hasUnread && (
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptyText}>
            Sign in to view your order requests.
          </Text>
          <TouchableOpacity
            style={styles.signInButton}
            onPress={() => router.push("/supplier/login")}
          >
