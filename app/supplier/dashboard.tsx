...
export default function SupplierDashboardScreen() {
  ...
  const updatePriceValue = (
    ...
    setEditedPrices((prev) =>
      prev.map((p) => (p.size === size ? { ...p, [field]: value } : p)),
    );
  };
          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.modalBody}>
              <View style={styles.modalRatingHeader}>
                <Text style={styles.modalBigRating}>
                ...
                <Text style={styles.modalTotalReviews}>
                  {supplierData.totalRatings || 0} reviews
                </Text>
              </View>

              <RatingBreakdown
                distribution={
                  supplierData.ratingDistribution || {
                    5: 0,
                    4: 0,
                    3: 0,
                    2: 0,
      ...
      >
        ...
        <View style={styles.statsRow}>
          ...
          >
            ...
            <Text style={styles.compactCardLabel}>
              {supplierData.totalRatings || 0} Reviews
            </Text>
          ...
          >
            <View
              style={[styles.compactCardIcon, { backgroundColor: "#E3F2FD" }]}
            >
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoRow}>
            ...
            <View style={styles.infoTextContainer}>
              ...
              <Text style={styles.infoValue}>
                {supplierData.openingHours?.open} -{" "}
                {supplierData.openingHours?.close}
              </Text>
            </View>
          </View>
        </View>
                ...
                <View style={styles.priceHeader}>
                  ...
                  <View style={styles.stockToggle}>
                    ...
                    <Switch
                      value={inStock}
                      onValueChange={(value) =>
                        updatePriceValue(size, "inStock", value)
                      }
                      trackColor={{ false: "#767577", true: "#81b0ff" }}
