...
import {
  deleteConversation,
  subscribeToSupplierConversations,
} from "@/services/chatService";
import {
  isNewOrderMessage,
  parseOrderMessageDetails,
...
export default function SupplierOrdersScreen() {
  ...
  const [mapConversationId, setMapConversationId] = useState<string | null>(
    null,
  );
        ...
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: async () => {
            ...
            if (!result.success) {
              ...
              Alert.alert(
                "Error",
                result.error || "Failed to mark as delivered",
              );
            }
          },
        },
  ...
  const renderConversation = ({ item }: { item: Conversation }) => {
    ...
    const orderDetails = lastMessage
      ? parseOrderDetails(lastMessage.text)
      : parseOrderDetails("");
      ...
      <View style={[styles.orderCard, hasUnread && styles.unreadCard]}>
        ...
        <View style={styles.customerSection}>
          ...
          <View style={styles.customerDetails}>
            <Text
              style={[styles.customerName, hasUnread && styles.unreadText]}
              numberOfLines={1}
            >
              {item.consumerName}
            </Text>
            <Text style={styles.customerPhone}>
              {item.consumerPhone || "No phone"}
            </Text>
          </View>
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.emptyContainer}>
          ...
          <TouchableOpacity
            ...
            onPress={() => router.replace("/supplier/login")}
          >
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={styles.headerSubtitle}>
            {conversations.length} order threads
          </Text>
        </View>
      </View>
