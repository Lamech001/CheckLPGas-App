    ...
    <SafeAreaView style={styles.safe}>
      ...
      >
        ...
        <Text style={styles.intro}>
          Welcome to GasAround, a mobile application that helps consumers find
          and compare cooking gas prices from nearby suppliers. These Terms of
          Service govern your use of the GasAround app. By using the app, you
        ...
        <Section title="3) Consumer Use">
          As a consumer, you may use the app to search for gas suppliers,
          compare prices, view supplier information, and place orders. You agree
          to use the app only for legitimate purposes and not for any fraudulent
          or illegal activities.
        </Section>

        <Section title="4) Supplier Use">
          As a supplier, you may list your gas business, set prices, manage
          orders, and communicate with consumers. You agree to provide accurate
          information about your business, prices, and availability. You are
          solely responsible for fulfilling orders placed through the app.
        </Section>
        ...
        <Section title="6) Location Services">
          The app may use your location to show nearby gas suppliers. You can
          enable or disable location services in your device settings. Disabling
          location services may limit the app's functionality.
        </Section>

        <Section title="7) User Content">
          You are responsible for any content you submit to the app, including
          business information, prices, reviews, and communications. You agree
          not to submit content that is illegal, harmful, threatening, abusive,
          or misleading.
        </Section>

        <Section title="8) Reviews and Ratings">
          Consumers may leave reviews and ratings for suppliers. Reviews must be
          honest and based on actual experiences. Suppliers may not post fake
          reviews or manipulate ratings.
        </Section>

        <Section title="9) Notifications">
          The app may send you push notifications about orders, messages, and
          other relevant information. You can manage your notification
          preferences in the app settings.
        </Section>

        <Section title="10) Intellectual Property">
          The GasAround app, its design, and all content are owned by GasAround
          and are protected by intellectual property laws. You may not copy,
          modify, or distribute the app without permission.
        </Section>
        ...
        <Section title="13) Limitation of Liability">
          ...
          arising from your use of the app, including but not limited to damages
        ...
        <Section title="15) Changes to Terms">
          ...
          material changes by posting the new Terms in the app. Your continued
